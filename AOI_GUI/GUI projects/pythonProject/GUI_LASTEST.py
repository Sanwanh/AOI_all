...
from PyQt5.QtWidgets import QWidget, QPushButton, QToolButton, QLCDNumber, QLabel, QApplication, QFrame, QLineEdit, QTextEdit
from PyQt5.QtWidgets import QApplication, QVBoxLayout, QLineEdit, QPushButton, QFileDialog
...
class mainWindow(QWidget):
    ...
    def ui(self):
        ...
        self.btn20.setGeometry(920, 330, 500, 100)
    ...
    def handle_btn7_click(self):
        save_path = 'C:\\Users\\pc\\Desktop\\GUI\\File'
        self.filePath, self.filterType = QFileDialog.getOpenFileNames(
            self, 'Open Files', save_path)  # 選取多個檔案
        # self.hide()
    ...
    def handle_btn9_click(self):
        self.gcode_command1 = 'G1 X-0.1 '
        self.gcode_command2 = 'G1 X0.1 '
        self.gcode_command3 = 'G1 Y-0.1 '
        self.gcode_command4 = 'G1 Y0.1 '
        # self.serial_port.write(b'a')  # Send 'a' to Arduino
        print("0.1")

    def handle_btn10_click(self):
        self.gcode_command1 = 'G1 X-1 '
        self.gcode_command2 = 'G1 X1 '
        self.gcode_command3 = 'G1 Y-1 '
        self.gcode_command4 = 'G1 Y1 '
        print("1")

    def handle_btn11_click(self):
        self.gcode_command1 = 'G1 X-10 '
        self.gcode_command2 = 'G1 X10 '
        self.gcode_command3 = 'G1 Y-10 '
        self.gcode_command4 = 'G1 Y10 '
        print("10")

    def handle_btn12_click(self):
        self.gcode_command1 = 'G1 X-25 '
        self.gcode_command2 = 'G1 X25 '
        self.gcode_command3 = 'G1 Y-25 '
        self.gcode_command4 = 'G1 Y25 '
        print("25")

    def handle_btn13_click(self):
        self.gcode_command1 = 'G1 X-50 '
        self.gcode_command2 = 'G1 X50 '
        self.gcode_command3 = 'G1 Y-50 '
        self.gcode_command4 = 'G1 Y50 '
        print("50")

    def handle_btn14_click(self):
        self.gcode_command1 = 'G1 X-100 '
        self.gcode_command2 = 'G1 X100 '
        self.gcode_command3 = 'G1 Y-100'
        self.gcode_command4 = 'G1 Y100 '
        print("100")

    def handle_btn15_click(self):
        x, y = self.getMotorPosition()
        self.display_box3.setText(f'X : {x:.2f} , Y : {y:.2f}')
