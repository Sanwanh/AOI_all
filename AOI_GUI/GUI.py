...
from PyQt5.QtWidgets import QWidget, QPushButton, QToolButton, QLCDNumber, QLabel, QApplication, QFrame, QLineEdit, QTextEdit, QFileDialog,QVBoxLayout
...
class mainWindow(QWidget):
    ...
    def opencv(self):
        ...
        model = torch.hub.load(r"C:\Users\puddi\Desktop\PythonCode\YOLO\pythonProject", 'custom',
                               path="runs/train/exp10/weights/best1.pt", source='local')
        #cap = cv2.VideoCapture(0)
        if not cap.isOpened():
